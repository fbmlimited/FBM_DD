                ...
                group(Dimensions)
                {
                    ...
                    action(DimensionsMultiple)
                    {
                        ...
                        begin
                            ...
                            DefaultDimMultiple.SetMultiRecord(Cust, rec.FieldNo(rec."No."));
